...
## Instructions
1. Pick the most relevant segment for the goal.
2. Pull pains/gains and draft the value proposition.
3. Add objections + reframes.
4. Produce a clean brief using the template.
